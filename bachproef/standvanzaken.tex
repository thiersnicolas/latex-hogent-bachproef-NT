...
Buiten REST en gRPC zijn er nog verschillende vari\"eteiten van web API's welke niet verder aan bod zullen komen in deze scriptie, maar die toch interesssant zijn om
...
biedt dit een groot voordeel daar zij specifiek enkel de data kunnen opvragen die ze op het scherm zullen weergeven, niet meer, niet minder, en waarschijnlijk slechts met één oproep.
...
Het verplicht gebruik van HTTP2 komt echter ook met het nadeel dat gRPC hierdoor niet ondersteund wordt door de hedendaagse browsers. Javascript heeft geen
...
%+ xml json
%+ gRPC REST SOAP HTML, .... evolutie van HTTP API's
%+ Serialisatie gRPC en REST + vergelijking -> meer in detail hoe de gRPC serialisatie werkt
%+ syntax proto https://protobuf.dev/getting-started/javatutorial/#:~:text=proto%20file%20are%20simple%3A%20you,proto%20.
% toch nog meer zeggen over proto bestand delen? vgl met soap wat waren daar de nadelen van -> aansluiten bij versionering? waarom is proto een gedoe